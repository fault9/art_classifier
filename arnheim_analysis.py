...
DIMENSIONS = {
    ...
    "Tension": {
        ...
        # HIGH: Baroque painters of violent narrative (Caravaggio, Rubens); Expressionists of
        # psychological anguish (Munch, Ensor, Kollwitz); Abstract Expressionist gestural energy
        # (Pollock, de Kooning, Gorky); Picasso's most distorted Surrealist works.
        "high": [
            ("Caravaggio", "Judith"),
            ("Caravaggio", "Martyrdom"),
            ("Caravaggio", "Conversion"),
            ("Caravaggio", "Crucifixion"),
            ...
            "Jackson Pollock",
            "Arshile Gorky",
            ("Pablo Picasso", "dance"),   # Surrealist distorted figures
            ("Pablo Picasso", "Kiss"),
        ],
        # LOW: Plein-air Impressionists whose quiet outdoor light creates visual calm (Monet,
        # Boudin, Bazille, Renoir, Morisot); serene Renaissance devotional works (Perugino,
        # Cima, Bellini); stillness of Wayne Thiebaud's desserts.
        "low": [
            "Claude Monet",
            "Eugene Boudin",
            "Frederic Bazille",
    ...
    "Color": {
        ...
        # HIGH: Deliberately crosses movement boundaries to stay independent of the Depth axis.
        # Fauvist/Post-Impressionist vivid colour (Matisse, Derain, Dufy, Chagall, Miro);
        # Expressionist intensity (Munch, Ensor); Abstract vivid (Kandinsky);
        # Pop commercial brightness (Warhol, Lichtenstein, Hiro Yamagata).
        "high": [
            "Henri Matisse",
            "Andre Derain",
            "Raoul Dufy",
        ...
        # LOW: Period-mixed dark/muted palette to avoid conflating Color with Depth.
        # Baroque dark masters (Caravaggio, Annibale/Agostino Carracci — hue suppressed by
        # chiaroscuro); monochrome Expressionism (Kollwitz); dark mystical palette (Morris Graves,
        # Albin Egger-Lienz); grey-brown Cubist palette (Braque); grey early Impressionists
        # (Boudin, Jongkind, Whistler).
        "low": [
            "Annibale Carracci",
            "Agostino Carracci",
            "Kathe Kollwitz",
            "Morris Graves",
            "Albin Egger-Lienz",
            "Georges Braque",           # grey-brown Analytic Cubist palette
            "Eugene Boudin",
            "Johan Jongkind",
            "James McNeill Whistler",
            ("Pablo Picasso", "Reservoir"),   # grey Analytic Cubism
            ("Pablo Picasso", "Guitar"),
        ],
    },
}
